...
Use when the weight is not known analytically, or when adapting it online
(multicanonical or Wang-Landau).
```julia
using MonteCarloX
...
`BinnedObject` supports discrete and continuous bin definitions,
including multidimensional bin tuples.
