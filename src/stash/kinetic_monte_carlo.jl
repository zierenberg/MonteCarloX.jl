# Kinetic Monte Carlo
# 
# Gillespie algorithm is the simplest form of kinetic Monte Carlo,
# analogous to how Metropolis is the simplest importance sampling.

# Gillespie - simplest KMC wrapper
...
simulation (simplest kinetic Monte Carlo).
"""
function init(
        rng::AbstractRNG,
        alg::Gillespie,
